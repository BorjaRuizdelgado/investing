...
export const MA_CONFIGS = [
  { period: 20,  color: MA_COLORS[20],  dash: "dot",     width: { forecast: 1.8, entry: 2   }, key: "ma20"  },
  { period: 50,  color: MA_COLORS[50],  dash: "dash",    width: { forecast: 2,   entry: 2.2 }, key: "ma50"  },
  { period: 200, color: MA_COLORS[200], dash: "dashdot", width: { forecast: 2.2, entry: 2.5 }, key: "ma200" },
];
